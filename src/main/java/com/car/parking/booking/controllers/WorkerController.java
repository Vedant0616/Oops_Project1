...
public class WorkerController {
	...
	public String deleteFavorites(@PathVariable("id") int id) {
		...
		return "redirect:/worker/savedParkingSpaces";
	}
	...
	public String addBooking(Model model, @PathVariable("id") int id,
		...
		if (result.hasErrors()) {
			...
			return "redirect:/worker/viewParkingSpace/" + id + "/calendar/showFormForAdd";
		}
		...
		if (bookingService.isOverlapping(booking, id) == false) {
			...
			return "redirect:/worker/viewParkingSpace/" + id + "/calendar";
